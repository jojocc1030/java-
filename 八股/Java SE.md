...
### 11. [对象的相等和引用相等的区别](https://javaguide.cn/java/basis/java-basic-questions-02.html#对象的相等和引用相等的区别)

- 对象相等一般比较的是**内存中存放的内容**是否相等。
- 引用相等一般比较的是他们**指向的内存地址**是否相等。

### 12. [深拷贝和浅拷贝区别了解吗？什么是引用拷贝？](#深拷贝和浅拷贝区别了解吗-什么是引用拷贝)
...
### 13. [HashCode() 和 equals()的关系](https://www.cnblogs.com/skywang12345/p/3324958.html)


### 14. [String、StringBuffer、StringBuilder 的区别？](https://javaguide.cn/java/basis/java-basic-questions-02.html#string、stringbuffer、stringbuilder-的区别)
